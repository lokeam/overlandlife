...
createServer({
    ...
    seeds(server) {
      server.create("rig", { id: "1", name: "Battuta", price: 70, description: "Estibulum nunc turpis, vulputate id faucibus ut, pharetra vitae ex. Duis non posuere orci. Cras pharetra mauris vel magna pellentesque, eu pulvinar elit aliquet.", imageUrl: "../src/assets/images/suvlogo.jpg", type: "simple" })
      server.create("rig", { id: "2", name: "Tokubei", price: 80, description: "In hac habitasse platea dictumst. Vestibulum vitae dui efficitur, vehicula quam at, tincidunt turpis.", imageUrl: "../src/assets/images/suvlogo.jpg", type: "rugged" })
      ...
      server.create("rig", { id: "5", name: "Polo", price: 120, description: "Aenean ultrices malesuada quam, bibendum viverra enim sodales vel. Maecenas ut velit eu risus convallis hendrerit in sit amet augue. Suspendisse ultrices varius risus sed tincidunt", imageUrl: "../src/assets/images/suvlogo.jpg", type: "luxury" })
      ...
      server.create("rig", { id: "11", name: "Moksadeva", price: 80, description: "Donec at ante porttitor, ultricies ipsum sed, malesuada sem. Vestibulum sagittis facilisis dapibus. Nam mauris augue, accumsan non tellus vel, luctus maximus orci.", imageUrl: "../src/assets/images/suvlogo.jpg", type: "simple" })
    },
